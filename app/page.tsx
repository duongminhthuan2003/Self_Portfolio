...
export default function Home() {
    ...
    return (
        <div className='scroll-snap overflow-hidden scrollbar-hide'>
            <motion.div
                className={`antialiased min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden scrollbar-hide`}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
