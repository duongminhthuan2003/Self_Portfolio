...
function UIUXPopup({ onClose }: { onClose: () => void }) {
    useEffect(() => {
            ...
            >
                <div className="flex flex-col gap-3 justify-center items-center h-[78dvh] w-full">
                    <div className="flex flex-row gap-3 h-8/12 w-full">
                        ...
                        >
                            <p className={`${sfProDisplayMedium.className} text-sm`}>UI Design</p>
                            <p className={`${sfProDisplayLight.className} text-sm`}>Visual hierarchy & layout, component-based UI, design systems</p>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            transition={{ease: "easeInOut", duration: 0.2, delay: 0.05}}
                        >
                            <p className={`${sfProDisplayMedium.className} text-sm`}>UX Design</p>
                            <p className={`${sfProDisplayLight.className} text-sm`}>User flows, wireframing, navigation design</p>
                        </motion.div>
                    </div>
                    ...
                    >
                        <p className={`${sfProDisplayMedium.className} text-sm`}>Designing tools</p>
                        <p className={`${sfProDisplayLight.className} text-sm`}>Adobe Illustrator, Figma</p>
